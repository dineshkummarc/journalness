...
{section name=searchpage show=$show_search_page}
  <div class="centered">
    ...
    <table border="0" cellpadding="0" cellspacing="1" width="75%" class="searchtable">
	<tr>
	  <th colspan="4" class="searchheader">
	    {$L_SEARCH_QUERY}
	  </th>
	</tr>
	<tr class="searchrow1">
	  <td colspan="2" class="searchcell" width="50%">
	    <strong>{$L_SEARCH_BY_KEYWORD}:</strong><br/>
	    {$L_SEARCH_BY_KEYWORD_EXPLAIN}
	  </td>
	  <td colspan="2" class="searchcell" width="50%">
	    <input type="text" name="search_text" class="textinput" size="40" maxlength="40" />
	  </td>
	<tr>
	<tr class="searchrow2">
	  <td colspan="2" class="searchcell" width="50%">
  ...
  {sectionelse}
	{section name=smallpreview show=$show_small_preview}
	  <div class="centered">
		...
		<tr style="background-color: {cycle values="#BBBBBB,#E9E9E9"}">
	...
	{sectionelse}
	{section name=titles}
	  <div class="centered"><table border="0" cellpadding="5">
 	   <tr>
		<td colspan="3" align="center">
		  <h4>{$L_SEARCH_RESULTS}</h4>
           ...
           <tr>
             <td>
               <table class="default_table" border="0" cellpadding="5" align="center">
