	  ...
	  <form action="profile.php?mode=editprofile" method="post">
		...
		<tr class="default_tablecell_alt1">
		  ...
		  <td style="text-align:left; width:50%;">
		    ...
		    <p><input class="textinput" type="text" name="profile_username" maxlength="30" size="30" value="{$user_value}"/> {$user_error}</p>
		    {else}
		    <p>{$user_value}</p>
		    {/if}
		  </td>
		...
		<tr class="default_tablecell_alt2">
		  ...
		  <td  style="text-align:left; width:50%;">
		    <p><input class="textinput" type="text" name="profile_email" maxlength="50" size="30" value="{$email_value}" /> {$email_error}</p>
		  </td>
		</tr>
		<tr class="default_tablecell_alt1">
		  <td  style="text-align:left; width:50%;">
		...
		<tr class="default_tablecell_alt2">
		  ...
		  <td   style="text-align:left; width:50%;">
		    <p><input class="textinput" type="password" name="profile_newpassword" maxlength="30" size="25" value="{$newpass_value}"/> {$newpass_error}</p>
		  </td>
		</tr>
		<tr class="default_tablecell_alt1">
		  <td  style="text-align:left; width:50%;">
		  ...
		  <td  style="text-align:left; width:50%;">
		    <p><input class="textinput" type="password" name="profile_newpassword_confirm" maxlength="30" size="25" value="{$conf_value}"/> {$conf_error}</p>
		  </td>
		</tr>
		<tr class="default_tableheader">
		  <th colspan="2" style="text-align:left;">
...
{section name=view_profile show=$show_view_profile}
  ...
  <table border="0" width="90%" cellpadding="0" cellspacing="0">
    <tr>
	<td style="text-align:center;">
	  <h4 style="margin-top: 1.0em;">{$L_VIEWING_PROFILE}</h4><br/>
